    ...
    return (
        <Canvas shadows={true}>
            ...
            <Suspense fallback={null}>
                ...
                <Texts color="white" Position={[0, 4, 80]} Textto="Recoge la lampara<br/>la necesitaras"/>
                <Texts color="white" Position={[0, 4, 75]} Textto="Los enemigos de sombra<br/>intentaran apagar tu lampara" rotation ={[0, 0, 0]}/>
                <Texts color="white" Position={[0, 4, 70]} Textto="En zonas oscuras<br/>perderas velocidad"/>
                <Texts color="white" Position={[0, 4, 65]} Textto="Si tu lampara esta apagada y esta<br/>oscuro perderas vida"/>
                <Texts color="white" Position={[7.3, 1, 45]} Textto="Puedes recargar tu lampara<br/>en las velas" fontSize={0.3} rotation={[0, -1.2, 0]}/>
                <Texts color="white" Position={[6, 1.5, 18]} Textto="Sigue las flores!" fontSize={0.3} rotation={[0, -1.2, 0]}/>
                <Texts color="white" Position={[0, 4, -20]} Textto="Busca la espada para derrotar<br/>al jabali!" fontSize={1} rotation={[0, 0, 0]}/>
                <Texts color="white" Position={[0, 4, -33]} Textto="Haz que choque contra<br/>los pilares o las paredes para<br/>aprovechar mientras esta aturdido" fontSize={0.8} rotation={[0, 0, 0]}/>
                <Texts color="white" Position={[0, 4, -45]} Textto="Encuentra las dos palancas<br/>en el laberinto para abrir<br/>el camino a la puerta de salida" fontSize={0.6} rotation={[0, 0, 0]}/>
                ...
                <Texts color="white" Position={[15, 4, -3]} Textto="Cambia entre espada y lampara con Q y E"
                 ...
                 <Texts color="white" Position={[0, 4, -96]} Textto="Felicidades!<br/>Has llegado al final del Nivel 1!"
